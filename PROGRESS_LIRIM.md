...
- **Active workstream:** _none yet — start with W1 (detail page) + W10 CI half per plan_
...
|---|---|---|---|
| W1 | Bug report detail / edit page | TODO | Independent, unblocks demo |
| W2 | Captured-context viewer | TODO | Reused by Donart in widget |
...
| W9 | Dashboards | TODO | |
| W10 | Bilingual web UI + CI workflow | TODO | CI half early, bilingual gradual |
